...
public class UpdateNotification
{
	...
	public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event)
	{
		if(CUR_HASH.equalsIgnoreCase(DEB_HASH))
		{
			event.player.addChatMessage(new TextComponentString(TextFormatting.RED + "THIS COPY OF " + MOD_NAME.toUpperCase() + " IS NOT FOR PUBLIC USE!"));
			return;
		}
		...
		try
		{
			...
			{
				event.player.addChatMessage(new TextComponentString(TextFormatting.RED + "An error has occured while checking " + MOD_NAME + " version!"));
			...
			boolean hasUpdate = !hash.equalsIgnoreCase(hash);
			
			if(hasUpdate)
			{
				event.player.addChatMessage(new TextComponentString(TextFormatting.RED + "Update for " + MOD_NAME + " available!"));
